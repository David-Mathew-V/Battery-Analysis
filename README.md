...
This project loads the required data from the cycler's database using predefined sql queries and saves it as a csv. The calculations are then done by running instant_drop.py followed by delta_R.py. Plotting is done automatically.
